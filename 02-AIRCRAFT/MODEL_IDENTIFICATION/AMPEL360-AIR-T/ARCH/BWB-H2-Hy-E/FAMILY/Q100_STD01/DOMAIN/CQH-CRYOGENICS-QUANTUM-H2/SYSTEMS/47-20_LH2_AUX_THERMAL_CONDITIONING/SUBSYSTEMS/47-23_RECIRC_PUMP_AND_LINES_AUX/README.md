# Subsystem: 47-23_RECIRC_PUMP_AND_LINES_AUX

## Description

Recirculation Pump and Lines (Auxiliary)

## Parent System

[47-20_LH2_AUX_THERMAL_CONDITIONING](../../) - ATA-47 Inert Gas/Cryogenics subsystem
...
```
47-23_RECIRC_PUMP_AND_LINES_AUX/
├─ README.md (this file)
└─ PLM/
   ├─ EBOM_LINKS.md
   └─ CAx/
...
- [⬆️ Back to 47-20_LH2_AUX_THERMAL_CONDITIONING](../../)
- [📂 All Subsystems](../)
- [🏠 SYSTEMS Home](../../../)
