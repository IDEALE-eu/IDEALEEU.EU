# Subsystem: 10-40_WEATHER_WIND_SENSORS

## Description

Environmental monitoring sensors for wind speed, gusts, and weather conditions.

This subsystem provides real-time environmental monitoring of wind speed, wind direction, gusts, temperature, and other weather parameters critical for safe mooring operations. Includes alerting and auto-tensioning triggering.
...
- Integration with Environment Monitoring (System 15)
