# Subsystem: 80-30_START_SEQUENCE_CONTROL_IF_73_76

## Description

Start Sequence Control Logic and Interfaces to ATA 73 (FADEC) and ATA 76 (Propulsion)
...
```
80-30_START_SEQUENCE_CONTROL_IF_73_76/
├─ README.md (this file)
└─ PLM/
   ├─ EBOM_LINKS.md
   └─ CAx/
