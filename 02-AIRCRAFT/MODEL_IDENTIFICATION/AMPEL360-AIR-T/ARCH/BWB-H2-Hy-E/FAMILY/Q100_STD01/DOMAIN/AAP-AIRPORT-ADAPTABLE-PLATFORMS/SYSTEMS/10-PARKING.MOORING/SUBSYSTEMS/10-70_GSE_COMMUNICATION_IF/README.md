# Subsystem: 10-70_GSE_COMMUNICATION_IF

## Description

Communication protocols and interfaces with autonomous ground support equipment.

This subsystem provides the communication infrastructure and protocols for interfacing with autonomous ground support equipment (GSE) including refueling systems, power carts, maintenance equipment, and autonomous vehicles.
...
- Airport Ground Link (AGL) protocol implementation
- Integration with Databus (System 93)
- Wireless and wired communication options
- Cybersecurity and authentication
- Protocol standardization across GSE fleet
- Backward compatibility with legacy GSE
