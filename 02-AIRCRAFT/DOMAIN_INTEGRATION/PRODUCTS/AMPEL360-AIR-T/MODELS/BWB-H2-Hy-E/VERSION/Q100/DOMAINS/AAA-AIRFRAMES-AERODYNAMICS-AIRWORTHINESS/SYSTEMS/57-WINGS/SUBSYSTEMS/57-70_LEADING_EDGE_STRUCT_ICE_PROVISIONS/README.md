# 57-70_LEADING_EDGE_STRUCT_ICE_PROVISIONS

## Description

Leading edge structural ice protection provisions (Interface with ATA-30)

## Purpose

This subsystem contains engineering artifacts, design data, and documentation for the 57-70_LEADING_EDGE_STRUCT_ICE_PROVISIONS components of the wing structure.
