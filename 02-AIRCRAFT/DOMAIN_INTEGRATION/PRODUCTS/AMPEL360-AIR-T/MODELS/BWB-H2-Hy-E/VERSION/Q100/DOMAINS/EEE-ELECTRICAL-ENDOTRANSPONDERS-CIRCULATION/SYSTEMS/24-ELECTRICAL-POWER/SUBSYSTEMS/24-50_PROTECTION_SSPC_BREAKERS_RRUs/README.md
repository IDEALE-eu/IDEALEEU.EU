# Subsystem: 24-50_PROTECTION_SSPC_BREAKERS_RRUs

## Description

Circuit Protection - Solid State Power Controllers (SSPC), Breakers, Remote Remote Units (RRUs)
...
```
24-50_PROTECTION_SSPC_BREAKERS_RRUs/
├─ README.md (this file)
└─ PLM/
   ├─ EBOM_LINKS.md
   └─ CAx/
