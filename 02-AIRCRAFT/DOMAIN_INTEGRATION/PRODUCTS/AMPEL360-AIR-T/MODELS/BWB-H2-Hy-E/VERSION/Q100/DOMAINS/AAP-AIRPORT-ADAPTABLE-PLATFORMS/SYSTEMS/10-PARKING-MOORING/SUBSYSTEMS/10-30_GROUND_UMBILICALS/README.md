# Subsystem: 10-30_GROUND_UMBILICALS

## Description

H₂, electrical, coolant, and data connection interfaces for ground services.

This subsystem provides the umbilical connection systems for hydrogen refueling, ground electrical power, thermal management (coolant), and high-speed data links during aircraft parking operations. Includes breakaway couplings for safety.
...
- Cryogenic H₂ transfer and thermal management (System 21)
- Electrical power capacity and grounding (System 24)
- Data protocol compatibility (System 31, 93)
- Emergency breakaway coupling mechanisms
- Leak detection and safety interlocks
