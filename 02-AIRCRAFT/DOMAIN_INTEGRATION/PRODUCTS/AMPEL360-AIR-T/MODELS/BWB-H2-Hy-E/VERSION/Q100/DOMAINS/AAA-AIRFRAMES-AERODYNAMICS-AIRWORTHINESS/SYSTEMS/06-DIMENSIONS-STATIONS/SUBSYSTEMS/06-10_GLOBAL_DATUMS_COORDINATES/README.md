# 06-10_GLOBAL_DATUMS_COORDINATES — Dimensions & Stations (BWB-H2-Hy-E, Q100)

**Purpose**  
Global aircraft datums and coordinate system definition

## Scope
- Detailed specifications and reference data for GLOBAL_DATUMS_COORDINATES
