# 57-50_HL_DEV_SUPPORTS_TRACKS_HINGES

## Description

High-lift device supports, tracks and hinges (flaps/slats/spoilers structural support, kinematics managed by ATA-27)

## Purpose

This subsystem contains engineering artifacts, design data, and documentation for the 57-50_HL_DEV_SUPPORTS_TRACKS_HINGES components of the wing structure.
