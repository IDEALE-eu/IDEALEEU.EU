# Subsystem: 10-60_SAFEHOLD_INTERLOCKS

## Description

Safety logic systems and propulsion inhibit interlocks during mooring.

This subsystem provides critical safety interlocks that prevent aircraft propulsion systems from being activated while the aircraft is moored or connected to ground equipment. Implements safe-to-move and safe-to-power logic.
...
- Safety-critical design and certification
