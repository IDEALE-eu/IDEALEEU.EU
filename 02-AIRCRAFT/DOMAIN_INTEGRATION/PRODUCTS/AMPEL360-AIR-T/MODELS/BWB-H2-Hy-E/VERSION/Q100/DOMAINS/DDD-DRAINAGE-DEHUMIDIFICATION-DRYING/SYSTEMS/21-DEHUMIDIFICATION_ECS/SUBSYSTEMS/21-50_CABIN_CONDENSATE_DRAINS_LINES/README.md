# Subsystem: 21-50_CABIN_CONDENSATE_DRAINS_LINES

## Description

Cabin air conditioning condensate collection and drainage

## Parent System

[21-DEHUMIDIFICATION_ECS](../../) - Part of DDD-DRAINAGE-DEHUMIDIFICATION-DRYING domain.
...
```
21-50_CABIN_CONDENSATE_DRAINS_LINES/
├─ README.md (this file)
└─ PLM/
   ├─ EBOM_LINKS.md
   └─ CAx/
...
- [⬆️ Back to 21-DEHUMIDIFICATION_ECS](../../)
...
- Parent System: [21-DEHUMIDIFICATION_ECS](../../README.md)
