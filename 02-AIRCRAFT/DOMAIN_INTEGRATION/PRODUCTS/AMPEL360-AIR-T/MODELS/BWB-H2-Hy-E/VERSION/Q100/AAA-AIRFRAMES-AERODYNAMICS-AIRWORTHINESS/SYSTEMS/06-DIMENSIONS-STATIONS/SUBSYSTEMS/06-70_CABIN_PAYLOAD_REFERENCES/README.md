# 06-70_CABIN_PAYLOAD_REFERENCES — Dimensions & Stations (BWB-H2-Hy-E, Q100)

**Purpose**  
Cabin and payload zone reference measurements

## Scope
- Detailed specifications and reference data for CABIN_PAYLOAD_REFERENCES
