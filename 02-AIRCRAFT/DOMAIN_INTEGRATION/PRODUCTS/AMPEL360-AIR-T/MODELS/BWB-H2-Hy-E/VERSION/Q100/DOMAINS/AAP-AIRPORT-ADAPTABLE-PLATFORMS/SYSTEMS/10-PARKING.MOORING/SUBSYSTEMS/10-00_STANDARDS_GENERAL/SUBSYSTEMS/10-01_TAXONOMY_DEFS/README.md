# Subsystem: 10-01_TAXONOMY_DEFS

## Description

Taxonomy definitions and classification standards for airport parking and mooring systems.

This subsystem contains the standardized taxonomy, nomenclature, and classification definitions used throughout the 10-PARKING.MOORING system. Provides consistent terminology for ground support equipment, mooring operations, and airport adaptable platform components.
...
- Standardized nomenclature for all mooring components
- Classification hierarchy for ground support equipment
- Terminology alignment with ATA 100 and airport standards
