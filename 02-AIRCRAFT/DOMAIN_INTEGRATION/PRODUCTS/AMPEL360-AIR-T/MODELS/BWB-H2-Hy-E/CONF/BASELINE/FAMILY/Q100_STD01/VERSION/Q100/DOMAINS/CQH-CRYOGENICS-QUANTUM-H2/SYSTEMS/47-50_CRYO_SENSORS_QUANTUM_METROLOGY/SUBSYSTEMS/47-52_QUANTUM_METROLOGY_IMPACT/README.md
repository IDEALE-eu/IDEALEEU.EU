# Subsystem: 47-52_QUANTUM_METROLOGY_IMPACT

## Description

Quantum Metrology Impact

## Parent System

[47-50_CRYO_SENSORS_QUANTUM_METROLOGY](../../) - ATA-47 Inert Gas/Cryogenics subsystem
...
```
47-52_QUANTUM_METROLOGY_IMPACT/
├─ README.md (this file)
└─ PLM/
   ├─ EBOM_LINKS.md
   └─ CAx/
...
- [⬆️ Back to 47-50_CRYO_SENSORS_QUANTUM_METROLOGY](../../)
- [📂 All Subsystems](../)
- [🏠 SYSTEMS Home](../../../)
