# Subsystem: 10-10_MOORING_ANCHORS

## Description

Physical mooring anchors and tie-down hardware for securing aircraft during ground operations.

This subsystem provides the mechanical attachment points and mooring hardware required to secure the BWB-H2-Hy-E aircraft during parking, maintenance, and high-wind conditions. Includes electromechanical or passive mooring anchors at wingtip and fuselage locations.
...
- Structural load capacity for high wind conditions
- Electromechanical actuation vs passive mooring
- Integration with aircraft hardpoints (System 51)
