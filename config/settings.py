...
class Settings:
    ...
    def __init__(self) -> None:
        ...
        self.log_level: LogLevel = self._get_log_level(
            "IDEALEEU_LOG_LEVEL", LogLevel.INFO
        )
    ...
    def __repr__(self) -> str:
        ...
        return (
            ...
            f"event_bus_url={self.event_bus_url.split('@')[0] if '@' in self.event_bus_url else self.event_bus_url})"
        )
