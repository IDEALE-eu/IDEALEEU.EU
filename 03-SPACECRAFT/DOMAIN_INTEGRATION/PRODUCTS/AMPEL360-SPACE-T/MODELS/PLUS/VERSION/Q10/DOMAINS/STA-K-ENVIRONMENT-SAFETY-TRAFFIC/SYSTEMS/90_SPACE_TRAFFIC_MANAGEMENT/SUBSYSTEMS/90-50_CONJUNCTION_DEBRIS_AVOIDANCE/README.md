# Subsystem: 90-50_CONJUNCTION_DEBRIS_AVOIDANCE

## Purpose

Maniobras de evasión y planificación de órbita

## Scope

Implements CONJUNCTION DEBRIS AVOIDANCE capabilities for the SPACE TRAFFIC MANAGEMENT system.
