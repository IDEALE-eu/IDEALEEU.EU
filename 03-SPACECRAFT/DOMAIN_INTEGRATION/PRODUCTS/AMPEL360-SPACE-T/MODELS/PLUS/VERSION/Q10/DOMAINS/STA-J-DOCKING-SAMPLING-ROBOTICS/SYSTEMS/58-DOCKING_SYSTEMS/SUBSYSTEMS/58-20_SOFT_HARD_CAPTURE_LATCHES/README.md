# Subsystem: 58-20_SOFT_HARD_CAPTURE_LATCHES

## Description
Engineering artifacts and documentation for the 58-20_SOFT_HARD_CAPTURE_LATCHES subsystem.
...
```
58-20_SOFT_HARD_CAPTURE_LATCHES/
├─ README.md (this file)
└─ PLM/
   ├─ EBOM_LINKS.md
   └─ CAx/
