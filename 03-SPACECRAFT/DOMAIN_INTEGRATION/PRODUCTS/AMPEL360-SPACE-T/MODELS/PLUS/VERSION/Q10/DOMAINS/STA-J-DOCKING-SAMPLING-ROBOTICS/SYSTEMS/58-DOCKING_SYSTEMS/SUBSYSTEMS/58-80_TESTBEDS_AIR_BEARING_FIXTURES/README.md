# Subsystem: 58-80_TESTBEDS_AIR_BEARING_FIXTURES

## Description
Engineering artifacts and documentation for the 58-80_TESTBEDS_AIR_BEARING_FIXTURES subsystem.
...
```
58-80_TESTBEDS_AIR_BEARING_FIXTURES/
├─ README.md (this file)
└─ PLM/
   ├─ EBOM_LINKS.md
   └─ CAx/
...
## Integration
Part of System 58 (Docking Systems) within STA-J domain.

## References
- [System 58 Integration View](../../INTEGRATION_VIEW.md)
- [System 58 Interface Matrix](../../INTERFACE_MATRIX/)
