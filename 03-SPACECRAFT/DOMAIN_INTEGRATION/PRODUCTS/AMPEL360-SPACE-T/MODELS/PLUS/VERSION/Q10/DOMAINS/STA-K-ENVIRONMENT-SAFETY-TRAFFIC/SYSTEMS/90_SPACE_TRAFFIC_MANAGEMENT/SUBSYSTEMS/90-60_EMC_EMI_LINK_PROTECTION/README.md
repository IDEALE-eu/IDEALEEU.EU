# Subsystem: 90-60_EMC_EMI_LINK_PROTECTION

## Purpose

Protección de enlaces de TT&C frente a interferencias

## Scope

Implements EMC EMI LINK PROTECTION capabilities for the SPACE TRAFFIC MANAGEMENT system.
