# Subsystem: 07-10_MGSE_MECHANICAL_HANDLING

## Description

Mechanical Ground Support Equipment: cranes, transport carts, handling fixtures, and positioning systems.
...
```
07-10_MGSE_MECHANICAL_HANDLING/
├─ README.md (this file)
└─ PLM/
   ├─ EBOM_LINKS.md
   └─ CAx/
