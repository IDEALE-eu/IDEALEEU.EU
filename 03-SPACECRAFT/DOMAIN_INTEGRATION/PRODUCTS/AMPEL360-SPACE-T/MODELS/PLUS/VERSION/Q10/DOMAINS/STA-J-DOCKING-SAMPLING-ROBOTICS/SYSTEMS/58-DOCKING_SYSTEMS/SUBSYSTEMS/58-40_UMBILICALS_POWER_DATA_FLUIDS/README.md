# Subsystem: 58-40_UMBILICALS_POWER_DATA_FLUIDS

## Description
Engineering artifacts and documentation for the 58-40_UMBILICALS_POWER_DATA_FLUIDS subsystem.
...
```
58-40_UMBILICALS_POWER_DATA_FLUIDS/
├─ README.md (this file)
└─ PLM/
   ├─ EBOM_LINKS.md
   └─ CAx/
