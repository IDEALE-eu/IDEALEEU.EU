# Subsystem: 59-80_TESTBEDS_REGOLITH_SIMULANTS

## Description
Engineering artifacts and documentation for the 59-80_TESTBEDS_REGOLITH_SIMULANTS subsystem.
...
```
59-80_TESTBEDS_REGOLITH_SIMULANTS/
├─ README.md (this file)
└─ PLM/
   ├─ EBOM_LINKS.md
   └─ CAx/
