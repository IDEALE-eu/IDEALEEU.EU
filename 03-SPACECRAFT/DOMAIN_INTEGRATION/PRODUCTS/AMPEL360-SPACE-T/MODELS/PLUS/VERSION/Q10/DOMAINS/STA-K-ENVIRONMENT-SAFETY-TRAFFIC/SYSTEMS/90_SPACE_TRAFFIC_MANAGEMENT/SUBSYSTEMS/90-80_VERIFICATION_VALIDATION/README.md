# Subsystem: 90-80_VERIFICATION_VALIDATION

## Purpose

Validación de algoritmos de STM y alertas

## Scope

Implements VERIFICATION VALIDATION capabilities for the SPACE TRAFFIC MANAGEMENT system.
