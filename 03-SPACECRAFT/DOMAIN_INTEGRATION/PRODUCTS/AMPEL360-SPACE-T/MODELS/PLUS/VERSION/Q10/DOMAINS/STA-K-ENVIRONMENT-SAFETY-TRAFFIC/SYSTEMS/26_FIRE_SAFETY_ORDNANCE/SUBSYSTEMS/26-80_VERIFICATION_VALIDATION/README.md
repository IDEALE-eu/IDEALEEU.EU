# Subsystem: 26-80_VERIFICATION_VALIDATION

## Purpose

Pruebas de ignición, contención y fallo seguro

## Scope

Implements VERIFICATION VALIDATION capabilities for the FIRE SAFETY ORDNANCE system.
