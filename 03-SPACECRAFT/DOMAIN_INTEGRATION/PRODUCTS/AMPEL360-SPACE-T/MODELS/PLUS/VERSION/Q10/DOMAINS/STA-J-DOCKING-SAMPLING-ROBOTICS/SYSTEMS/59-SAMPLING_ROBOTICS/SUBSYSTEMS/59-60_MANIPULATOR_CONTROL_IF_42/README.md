# Subsystem: 59-60_MANIPULATOR_CONTROL_IF_42

## Description
Engineering artifacts and documentation for the 59-60_MANIPULATOR_CONTROL_IF_42 subsystem.
...
```
59-60_MANIPULATOR_CONTROL_IF_42/
├─ README.md (this file)
└─ PLM/
   ├─ EBOM_LINKS.md
   └─ CAx/
