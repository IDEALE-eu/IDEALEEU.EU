# Subsystem: 87-80_VERIFICATION_VALIDATION

## Purpose

Simulaciones (GEANT4, SPENVIS) y pruebas

## Scope

Implements VERIFICATION VALIDATION capabilities for the RADIATION ENVIRONMENT system.
