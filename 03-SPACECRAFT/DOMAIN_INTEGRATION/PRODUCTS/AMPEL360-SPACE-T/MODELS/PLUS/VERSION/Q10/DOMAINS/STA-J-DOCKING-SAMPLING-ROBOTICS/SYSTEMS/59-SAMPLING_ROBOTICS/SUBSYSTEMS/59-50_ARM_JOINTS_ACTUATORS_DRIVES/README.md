# Subsystem: 59-50_ARM_JOINTS_ACTUATORS_DRIVES

## Description
Engineering artifacts and documentation for the 59-50_ARM_JOINTS_ACTUATORS_DRIVES subsystem.
...
```
59-50_ARM_JOINTS_ACTUATORS_DRIVES/
├─ README.md (this file)
└─ PLM/
   ├─ EBOM_LINKS.md
   └─ CAx/
