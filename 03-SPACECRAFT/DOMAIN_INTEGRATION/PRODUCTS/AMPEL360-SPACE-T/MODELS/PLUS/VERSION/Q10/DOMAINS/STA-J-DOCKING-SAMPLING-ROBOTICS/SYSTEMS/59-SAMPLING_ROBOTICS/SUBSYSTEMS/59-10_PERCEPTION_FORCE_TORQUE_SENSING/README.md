# Subsystem: 59-10_PERCEPTION_FORCE_TORQUE_SENSING

## Description
Engineering artifacts and documentation for the 59-10_PERCEPTION_FORCE_TORQUE_SENSING subsystem.
...
### Engineering BOM
- [EBOM_LINKS.md](./PLM/EBOM_LINKS.md) - Engineering BOM references
...
- [CAP/](./PLM/CAx/CAP/) - Computer-Aided Planning (assembly planning, logistics)
...
```
59-10_PERCEPTION_FORCE_TORQUE_SENSING/
├─ README.md (this file)
└─ PLM/
   ├─ EBOM_LINKS.md
   └─ CAx/
...
## Integration
Part of System 59 (Sampling Robotics) within STA-J domain.

## References
- [System 59 Integration View](../../INTEGRATION_VIEW.md)
- [System 59 Interface Matrix](../../INTERFACE_MATRIX/)
