# Subsystem: 87-60_EMC_EMI_INTERACTIONS

## Purpose

Acoplamiento radiación-EMI en sistemas electrónicos

## Scope

Implements EMC EMI INTERACTIONS capabilities for the RADIATION ENVIRONMENT system.
