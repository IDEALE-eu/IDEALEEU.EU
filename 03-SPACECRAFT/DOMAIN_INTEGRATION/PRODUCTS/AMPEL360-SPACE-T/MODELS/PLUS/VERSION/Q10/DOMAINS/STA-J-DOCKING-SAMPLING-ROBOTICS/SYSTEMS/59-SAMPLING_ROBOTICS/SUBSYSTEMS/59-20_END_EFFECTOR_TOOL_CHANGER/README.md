# Subsystem: 59-20_END_EFFECTOR_TOOL_CHANGER

## Description
Engineering artifacts and documentation for the 59-20_END_EFFECTOR_TOOL_CHANGER subsystem.
...
```
59-20_END_EFFECTOR_TOOL_CHANGER/
├─ README.md (this file)
└─ PLM/
   ├─ EBOM_LINKS.md
   └─ CAx/
